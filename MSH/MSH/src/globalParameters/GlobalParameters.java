...
public class GlobalParameters {
	...
	/**
	 * Number of threads for the sampling phase. How many sampling functions will
	 * work in parallel.
	 */
	 ...
	 */
	public static final boolean PRINT_IN_CONSOLE = GlobalParametersReader.<String>get("PRINT_IN_CONSOLE", String.class)
			.equals("false") ? false : true;

	/**
	 * Should we print in a txt file the pools?
	 */
	public static final boolean PRINT_POOLS_TO_FILE = GlobalParametersReader
			.<String>get("PRINT_POOLS_TO_FILE", String.class).equals("false") ? false : true;
	...
	public static double ROUTE_WALKING_DISTANCE_LIMIT = GlobalParametersReader
			.<Double>get("ROUTE_WALKING_DISTANCE_LIMIT", Double.class);

	/**
	 * Walking duration limit in minutes
	 */

	public static double ROUTE_DURATION_LIMIT = GlobalParametersReader.<Double>get("ROUTE_DURATION_LIMIT",
			Double.class);
	 ...
	 */
	public static final int MSH_NUM_ITERATIONS = GlobalParametersReader.<Integer>get("MSH_NUM_ITERATIONS",
			Integer.class);

	/**
	 * Time limit for the sampling phase in seconds
	 */
	public static final int MSH_SAMPLING_TIME_LIMIT = GlobalParametersReader.<Integer>get("MSH_SAMPLING_TIME_LIMIT",
			Integer.class);

	/**
	 * Randomization factor (large value) for the tsp heuristics
	 */
	public static final int MSH_RANDOM_FACTOR_HIGH = GlobalParametersReader.<Integer>get("MSH_RANDOM_FACTOR_HIGH",
			Integer.class);

	/**
	 * Randomization factor (large value) for the tsp heuristics
	 */
	public static final int MSH_RANDOM_FACTOR_HIGH_RN = GlobalParametersReader.<Integer>get("MSH_RANDOM_FACTOR_HIGH_RN",
			Integer.class);

	/**
	 * Randomization factor (small value) for the tsp heuristics
	 */
	public static final int MSH_RANDOM_FACTOR_LOW = GlobalParametersReader.<Integer>get("MSH_RANDOM_FACTOR_LOW",
			Integer.class);

	/**
	 * Time limit for the assembly phase in seconds
	 */
	public static final int MSH_ASSEMBLY_TIME_LIMIT = GlobalParametersReader.<Integer>get("MSH_ASSEMBLY_TIME_LIMIT",
			Integer.class);

	/**
	 * Heatmap parameters
	 */
	/* The distance for fixed arcs */
	public static final double FIXED_ARCS_DISTANCE = GlobalParametersReader.<Double>get("FIXED_ARCS_DISTANCE",
			Double.class, -0.1);

	/* The folder containing the coordinates files */
	public static final String COORDINATES_FOLDER = GlobalParametersReader.<String>get("COORDINATES_FOLDER",
			String.class, "./instances_modified/");

	/* The folder containing the arcs files */
