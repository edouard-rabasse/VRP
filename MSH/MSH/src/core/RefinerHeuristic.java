 ...
 *
 */
public class RefinerHeuristic implements TSPHeuristic, RandomizedHeuristic {
	 ...
	 * @param distances
	 */
	public RefinerHeuristic(DistanceMatrix distances, String instance_id){
	...
	public synchronized TSPSolution run() {
		...
		String path = "./results/configuration1/Arcs_"+this.instance_id+"_"+GlobalParameters.SEED+".txt";
		int parkingSpot = -1;
