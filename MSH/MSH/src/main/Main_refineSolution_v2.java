 ...
 * 
 * This class relies on the fact that the MSH was already used to solve all instances,
 * and that the solutions are available. To avoid errors, if the solution is not available
 ...
 *
 */
public class Main_refineSolution_v2 {
		...
		// Runs the code:
			...
			try {
				...
				// Runs the MSH:
					...
					manager.runRefineRoutes(instance_identifier);
