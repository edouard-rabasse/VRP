...
public class MSH implements Algorithm {
	...
	/**
	 * This method runs the assembly phase. It calls the CPLEX set partitioning
	 * solver.
	 * 
	 * @return
	 */
	...
	/**
	 * This method returns the current size of the pool, summing the size of the
	 * individual pools.
	 * 
	 * @return
	 */
