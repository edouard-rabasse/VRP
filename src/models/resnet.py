    ...
    def __init__(
        ...
        *,
        ...
        self.backbone.conv1 = nn.Conv2d(
            input_channels, 64, kernel_size=kernel_size, stride=1, padding=2, bias=False
        )
        ...
        nn.init.kaiming_normal_(self.backbone.fc.weight, nonlinearity="linear")
...
def train_model(
    ...
    if cfg.model.freeze:
        head_params = list(model.backbone.fc.parameters()) + list(
            model.backbone.layer4.parameters()
        )
        backbone_new = list(model.backbone.conv1.parameters()) + list(
