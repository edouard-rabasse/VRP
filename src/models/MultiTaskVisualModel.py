...
if __name__ == "__main__":
    ...
    train_loader, test_loader = load_data_mask(
        ...
        mask_path=mask_path,
        num_max=20,
        image_transform_test=image_transform_test(size=(84, 84)),
        image_transform_train=image_transform_train(size=(84, 84)),
        mask_transform_train=mask_transform(size=(84, 84)),
    )
