...
java -Xmx14000m "-Djava.library.path=C:\gurobi1201\win64\bin" -cp "bin;C:\gurobi1201\win64\lib\gurobi.jar" main.Main_customCosts Coordinates_1.txt Costs_1_2.txt configurationCustomCosts2.xml Arcs_1_2.txt 2
...
python src/test/plot_one.py -c "MSH\MSH\instances\Coordinates_1.txt" -a "MSH\MSH\results\configurationCustomCosts\Arcs_1_3.txt" 