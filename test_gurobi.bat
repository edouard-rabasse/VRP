...
java -Xmx14000m "-Djava.library.path=C:\gurobi1201\win64\bin" -cp "bin;C:\gurobi1201\win64\lib\gurobi.jar" main.Main_customCosts Coordinates_7.txt Costs_7_1.txt configurationCustomCosts2.xml Arcs_7_1.txt 1
