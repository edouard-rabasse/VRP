...
java -Xmx14000m "-Djava.library.path=C:\gurobi1201\win64\bin" -cp "bin;C:\gurobi1201\win64\lib\gurobi.jar" main.Main_refineUpperRightConstraint ExperimentsAllSets.txt 5 configurationCustomCosts.xml 
...
python src/test/plot_one.py -c "MSH\MSH\instances\Coordinates_5.txt" -a "MSH\MSH\results\configurationCustomCosts\Arcs_5_1.txt" 